...
red_thresholds = (47, 0, 78, 11, 65, -31)    #定义红色阈值变量
green_thresholds = (0, 0, 0, 0,0,0)    #定义绿色阈值变量
...
while(True):
    ...
    if value == 0:
        ...
        image.draw_string(0, 0, thresholds_num, color=(255,0,0))
        if thresholds_num % 2 == 1:
            #计算颜色阈值，这样写的话，颜色阈值是实时变化的，后续想要什么效果可以自己修改
            red_thresholds = (lab[0]-20,lab[0]+20, lab[1]-20, \
                            lab[1]+20,lab[2]-20, lab[2]+20,)
        else:
            green_thresholds = (lab[0]-20,lab[0]+20, lab[1]-20, \
                            lab[1]+20,lab[2]-20, lab[2]+20,)
