...
while(True):
    ...
    if value == 0:
        ...
        #打印LAB的最小值和最大值
        print(statistics_Data.l_min()) 
        print(statistics_Data.l_max()) 
        print(statistics_Data.a_min())
        print(statistics_Data.a_max()) 
        print(statistics_Data.b_min())
        print(statistics_Data.b_max()) 
    
        lab[0] =  statistics_Data.l_min()
        lab[1] =  statistics_Data.l_max()
        lab[2] =  statistics_Data.a_min()
        lab[3] =  statistics_Data.a_max()
        lab[4] =  statistics_Data.b_min()
        lab[5] =  statistics_Data.b_max()
        
        #计算颜色阈值，这样写的话，颜色阈值是实时变化的，后续想要什么效果可以自己修改
        red_thresholds = (lab[0],lab[1], lab[2], \
                            lab[3], lab[4], lab[5])
